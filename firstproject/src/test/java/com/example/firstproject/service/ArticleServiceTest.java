...
class ArticleServiceTest {
    ...
    void show_실패____존재하지_않은_id_입력() {
        ...
        // 비교
        assertEquals(expected, article); // null은 tostring 불가
    }

    @Test
    @Transactional // 롤백을 위해서 안해주면 index()에서 에러남 insert되기 때문
    ...
    void create_실패____id가_포함된_dto_입력() {
        ...
        String title = "라라라라";
        String content = "4444";
        ArticlesForm dto = new ArticlesForm(4L, title, content);
        Article expected = null;
